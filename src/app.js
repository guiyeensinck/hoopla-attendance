...
app.command('/ayuda', async ({ ack, respond }) => {
  ...
  await respond({
    ...
    blocks: [
      ...
      { type: 'section', text: { type: 'mrkdwn', text: '`/admin agregar @usuario` — Sumá a alguien al sistema de asistencia.\n`/admin sacar @usuario` — Quitá a alguien del seguimiento.' } },
      { type: 'section', text: { type: 'mrkdwn', text: '`/admin lista` — Ver todos los comandos de administración disponibles.' } },
      { type: 'divider' },
